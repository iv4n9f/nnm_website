// i18n.js — carga JSON por idioma y aplica [data-i18n] / [data-i18n-attr]
(function () {
  ...
  function tokenize(str) {
    ...
    const unit = (unitEl && unitEl.textContent.trim()) || (sel?.value === "USD" ? " $" : " €");
  ...
  // Re-render cuando cambie la moneda (lo dispara theme-currency.js)
  window.addEventListener("nnm:currency-changed", () => applyText(currentDict));

  // Exponer función manual por si quieres forzar re-render
  window.nnmI18nApply = () => applyText(currentDict);
