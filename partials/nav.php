  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="mainNav">
      ...
      <div class="d-flex align-items-center gap-2">
          <div class="dropdown">
            <button class="btn btn-outline-primary dropdown-toggle" id="btnLang" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <div class="dropdown">
            <button class="btn btn-outline-primary dropdown-toggle" id="btnCurrency" data-bs-toggle="dropdown" aria-expanded="false">
