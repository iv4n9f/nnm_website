    ...
    <div class="row align-items-center">
      <div class="col-md-6 text-md-start">
        ...
        <div class="d-flex gap-2 justify-content-center justify-content-md-start">
          ...
          <button class="btn btn-outline-primary" onclick="document.querySelector('#pricing').scrollIntoView({behavior:'smooth'})" data-i18n="hero.cta_secondary">Ver precios</button>
          <span class="badge bg-secondary align-self-center">Desde <span class="price price-badge" data-price="PRICE_VPN"></span><span class="unit"></span> / mes</span>
        </div>
        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row text-center">
              <div class="col"><strong>UK</strong><div class="text-muted small">nnmsrvuk01</div></div>
              <div class="col"><strong>DE</strong><div class="text-muted small">nnmsrvde01</div></div>
              <div class="col"><strong>E2E</strong><div class="text-muted small">Bitwarden</div></div>
            </div>
          </div>
        </div>
      </div>
